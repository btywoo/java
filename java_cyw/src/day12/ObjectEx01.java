...
public class ObjectEx01 {
	...
	public static void main(String[] args) throws CloneNotSupportedException {
		...
		Student std3 = new Student(1,1,1,"김엘사");
...
class Student implements Cloneable{
	...
	public boolean equals(Object obj) {
		if (this == obj) // 주소가 같은 경우 > 같은 객체를 공유
			return true; 
		if (obj == null) // 비교 대상이 null인 경우 > 비교할 수 없음
			return false;
		if (getClass() != obj.getClass()) // 내 클래스와 매개변수의 클래스가 다른 경우
			return false;
		
		// 내 클래스와 매개변수의 클래스가 같을 때
