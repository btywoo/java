...
public class ListEx01 {
	...
	public static void main(String[] args) {
		...
		// remove(번지, 객체) : 리스트에서 번지 위치에 있는 객체를 삭제하고 삭제된 객체를 반환. 리스트 인터페이스
		
		list.add("홍길동");
		
		System.out.println(list.get(0));
		// get(번지) : 번지 위치에 있는 객체를 가져옴. 리스트 인터페이스에서 구현
